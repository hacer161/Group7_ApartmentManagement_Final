...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dao_login= new DAO_Login(getApplicationContext());
        dao_login.opend();
        ...
        btnDk.setOnClickListener(view->{
            if(checkSignin()==true){
                if(Signin()==true){
                    ...
                    Toast.makeText(RegisterActivity.this, "Đăng ký thất bại ( Có thể UserName đã tồn tại)" , Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public boolean Signin() {
        ...
        long res = dao_login.insertAdmin(obj);
        if (res > 0) {
